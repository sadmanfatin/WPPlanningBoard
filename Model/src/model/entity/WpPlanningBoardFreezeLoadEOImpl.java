...
public class WpPlanningBoardFreezeLoadEOImpl extends EntityImpl {
    ...
    /**
     * Gets the attribute value for PlanningBoardLoadId, using the alias name PlanningBoardLoadId.
     * @return the PlanningBoardLoadId
     */
    public Number getPlanningBoardLoadId() {
        return (Number)getAttributeInternal(PLANNINGBOARDLOADID);
    }

    /**
     * Sets <code>value</code> as the attribute value for PlanningBoardLoadId.
     * @param value value to set the PlanningBoardLoadId
     */
    public void setPlanningBoardLoadId(Number value) {
        setAttributeInternal(PLANNINGBOARDLOADID, value);
    }
    ...
    /**
     * @param planningBoardLoadId key constituent

     * @return a Key object based on given key constituents.
     */
    public static Key createPrimaryKey(Number planningBoardLoadId) {
        return new Key(new Object[]{planningBoardLoadId});
    }
    ...
    protected void create(AttributeList attributeList) {
        ...
        new oracle.jbo.server.SequenceImpl("WP_PLANNING_BOARD_LOAD_SEQ",  getDBTransaction());
        oracle.jbo.domain.Number sVal = s.getSequenceNumber();
        this.setPlanningBoardLoadId(sVal);
    }
